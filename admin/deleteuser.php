    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
         <h2>Delete User</h2>
            <div class="table-responsive" style="max-width: 1100px; margin-top: -80px;">
              <table class="table table-hover table-condensed table-bordered table-sm">
                ...
                <tbody>
                  ...
                  <div class="form-group row">
                    <td style="width: 50px; text-align: center;"><?php echo $row['UID']; ?></td>
                    <td style="width: 120px;"><?php echo $row['First_Name']; ?></td>
                    <td style="width: 120px;"><?php echo $row['Last_Name']; ?></td>
                    <td style="width: 150px;"><?php echo $row['Username']; ?></td>
                    <td style="width: 110px;"><?php echo $row['Admission_No']; ?></td>
                    <td style="width: 150px;"><?php echo $row['Email_Id']; ?></td>
                    <td style="width: 120px;"><?php echo $row['Mobile_No']; ?></td>
                    <td style="width: 90px;">
                      <form method="POST" action="./deleteuserphp.php">
                       <button class="btn btn-sm btn-danger" name="BTN" value="<?php echo $row['UID'];?>">Delete</button>
