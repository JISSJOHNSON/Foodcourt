    ...
    <div class="container-fluid">
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar fixed">
          <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column mb-2">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="./deletefood.php">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
         <h2>Delete Food</h2>
            <div class="table-responsive" style="max-width: 1100px; margin-top: -50px;">
              <table class="table table-hover table-condensed table-bordered table-sm">
                ...
                <tbody>
                  ...
                  <div class="form-group row">
                    <td style="width: 50px; text-align: center;"><?php echo $row['FID']; ?></td>
                    <td style="width: 120px;"><?php echo $row['Name']; ?></td>
                    <td style="width: 120px;"><?php echo $row['Rate']; ?></td>
                    <td style="width: 150px;"><?php echo $row['Quantity']; ?></td>
                    <td style="width: 90px;">
                      <form method="POST" action="./deletefoodphp.php">
                       <button class="btn btn-sm btn-danger" name="BTN" value="<?php echo $row['FID'];?>">Delete</button>
