        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar fixed">
          <div class="sidebar-sticky">
            ...
            <ul class="nav flex-column mb-2">
              <li class="nav-item">
                <a class="nav-link active" href="./addfood.php">
          ...
          <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title text-center">Add Food</h3>
              </div>
              <div class="panel-body">
                <form role="form" method="POST" action="./addfoodphp.php">
                  <div class="form-group">
                    <input type="text" name="F_Name" id="F_Name" class="form-control input-sm" placeholder="Food Name">
                  </div>
                  <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                        <input type="text" name="F_Rate" id="F_Rate" class="form-control input-sm" placeholder="Rate">
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                        <input type="text" name="F_Qty" id="F_Qty" class="form-control input-sm" placeholder="Quantity">
                      </div>
                    </div>
                  </div>
                  <input type="submit" value="Add Food" class="btn btn-info btn-block">
                </form>
            </div>
          </div>
        </div>
